...
export default function Register() {
  ...
  const handleGoogleSignup = async () => {
    if (DEMO_MODE) { navigate('/onboarding'); return; }
            ...
            <>
              ...
              <div className="relative my-5">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="px-3 bg-white text-outline">או הרשם עם</span>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-3 rounded-xl font-semibold text-sm transition-all cursor-pointer hover:bg-gray-50 disabled:opacity-60 border border-outline-variant/50 text-on-surface bg-white"
              >
                {googleLoading ? (
